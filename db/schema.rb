...
ActiveRecord::Schema.define(version: 2020_07_22_125350) do

  create_table "charge_cards", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "user_id"
    t.string "card_id"
    t.string "last_4"
    t.string "card_type"
    ...
    t.index ["user_id"], name: "index_charge_cards_on_user_id"
  end
